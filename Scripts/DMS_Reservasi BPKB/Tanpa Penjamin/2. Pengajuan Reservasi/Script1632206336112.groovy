...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathreservasibpkb1) + 'skenario-2.2-input pengajuan reservasi') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathreservasibpkb1) + 'skenario-2.3-konfirmasi pengajuan reservasi') + 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathreservasibpkb1) + 'skenario-2.4-syarat dan ketentuan') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathreservasibpkb1) + 'skenario-2.5-tampilan billing') + '.png', FailureHandling.STOP_ON_FAILURE)
