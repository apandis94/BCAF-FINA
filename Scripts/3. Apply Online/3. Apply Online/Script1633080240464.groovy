...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-3.1-apply tenor 1 thn') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-3.2-form upload data') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'SS Cust data 1'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-3.3-form cust data 1') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'SS Cust data 2'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-3.4-form cust data 2') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'SS Car Data'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-3.5-form car data') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-3.6-berhasil submit data') + '.png', FailureHandling.STOP_ON_FAILURE)
