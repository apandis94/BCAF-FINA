...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-1.1-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-1.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
