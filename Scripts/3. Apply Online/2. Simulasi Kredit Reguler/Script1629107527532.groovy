...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-2.1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-2.2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
