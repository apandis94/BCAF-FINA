...
Mobile.setText(findTestObject('APN_FINA_ClaimAsuransi/Fina1 (Login)/android.widget.EditText - Email (1)'), findTestData(
        'DMS_Claim_Assurance').getObjectValue('Login', 33), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathklaimasuransi) + 'Account') + '.png', FailureHandling.STOP_ON_FAILURE)
