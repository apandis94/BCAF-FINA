...
Mobile.setText(findTestObject('APN_FINA_ClaimAsuransi/Fina1 (Login)/android.widget.EditText - Email (1)'), findTestData(
        'DMS_Claim_Assurance').getObjectValue('Login', 7), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'CA User & Pass - Login') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'Account') + '.png', FailureHandling.STOP_ON_FAILURE)
