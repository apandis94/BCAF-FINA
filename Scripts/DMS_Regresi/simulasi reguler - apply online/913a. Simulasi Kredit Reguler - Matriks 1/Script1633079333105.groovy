...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-13.3-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-13.4-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
