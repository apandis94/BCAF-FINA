...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-2.9-logout akun') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Account/FINA_Account_Logout_Button'), 0)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-2.10-konfirmasi logout') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(25)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-2.11-berhasil logout, kembali ke menu utama') + 
