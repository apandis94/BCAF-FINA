...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Text'), 'sanusi@mailinator.com', 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Password_Text'), '123abc', 0)

Mobile.hideKeyboard()

Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-14.1-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-14.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
