...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-15.3-list kendaraan') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.4-submit renewal') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.5-konfirmasi renewal') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.6-proses submit berhasil') + '.png', 
