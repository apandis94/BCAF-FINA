...
CucumberKW.comment('Angsuran Dimuka & Verifikasi')
...
CucumberKW.comment('Angsuran Dibelakang & Verifikasi')

Mobile.tap(findTestObject('APN_Apply Online/1.13 Button Angsuran Dibelakang'), 0)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Tenor 1'), 
    AB_Tenor_1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total DP 1'), 
    AB_DP_1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 1'), 
    AB_Angsuran_1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Tenor 2'), 
    AB_Tenor_2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total DP 2'), 
    AB_DP_2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 2'), 
    AB_Angsuran_2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Tenor 3'), 
    AB_Tenor_3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total DP 3'), 
    AB_DP_3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 3'), 
    AB_Angsuran_3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Tenor 4'), 
    AB_Tenor_4, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total DP 4'), 
    AB_DP_4, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 4'), 
    AB_Angsuran_4, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Tenor 5'), 
    AB_Tenor_5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total DP 5'), 
    AB_DP_5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 5'), 
    AB_Angsuran_5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 5-1'), 
    AB_Angsuran_5_1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Tenor 6'), 
    AB_Tenor_6, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total DP 6'), 
    AB_DP_6, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 6'), 
    AB_Angsuran_6, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('APN_Apply Online/Verify Element/Budget - Angsuran Dibelakang/Angsuran Dibelakang - Total Anguran 6-1'), 
