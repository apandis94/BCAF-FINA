...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathepoliscakpro) + 'skenario-3.18-list kendaraan') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('APN_Fina New Versi/Customer_Info/E-Polis/Fina_LayananKon_Epolis_ListData1'), 0)

Mobile.delay(2)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathepoliscakpro) + 'skenario-3.19-list epolis') + '.png', FailureHandling.STOP_ON_FAILURE)
