...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-13.4-submit renewal') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Renewal_Asuransi/android.widget.EditText - Nomor Telepon  HP'), findTestData(
        'DMS_Asr_Cakpro').getObjectValue('No tlp', 58), 0)

Mobile.delay(10)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-13.5-konfirmasi renewal') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-13.6-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
