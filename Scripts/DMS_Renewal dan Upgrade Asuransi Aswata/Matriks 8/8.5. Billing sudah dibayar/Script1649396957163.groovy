...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-8.16-list billing belum dibayar') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-8.17-list billing sudah dibayar') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
