...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Text'), findTestData('DMS_Asr_Cakpro').getObjectValue('Login', 53), 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Password_Text'), findTestData('DMS_Asr_Cakpro').getObjectValue('Pass', 53), 0)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-12.1-input username dan password') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-12.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
