...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-10.3-list kendaraan') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Renewal_Asuransi/FINA_RenewalAsr_List_ListKendaraan1_Button'), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-10.4-submit renewal') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Renewal_Asuransi/android.widget.EditText - Nomor Telepon  HP'), findTestData(
        'DMS_Asr_Cakpro').getObjectValue('No tlp', 65), 0)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-10.5-konfirmasi renewal') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-10.6-proses submit berhasil') + '.png', 
