...
Mobile.setText(findTestObject('DMS_FINA_Mobile/test/android.widget.EditText - Email'), findTestData('DMS_Asr_Cakpro').getObjectValue(
        'Login', 1), 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/test/android.widget.EditText - Password'), findTestData('DMS_Asr_Cakpro').getObjectValue(
        'Pass', 1), 0)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.1-input username dan password') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.2-berhasil login') + '.png', 
