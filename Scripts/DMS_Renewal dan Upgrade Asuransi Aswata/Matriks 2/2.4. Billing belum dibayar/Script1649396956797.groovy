...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.10-list billing belum dibayar') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.11-list billing sudah dibayar') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.12-detail billing belum dibayar') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.13-kirim email billing') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.14-dokumen terkirim') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
not_run: Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.15-dokumen tersimpan') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
