...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Text'), findTestData('DMS_Asr_Cakpro').getObjectValue('Login', 
        7), 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Password_Text'), findTestData('DMS_Asr_Cakpro').getObjectValue(
        'Pass', 7), 0)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.1-input username dan password') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-2.2-berhasil login') + '.png', 
