...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.3-list kendaraan') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.4-pilih tenor') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.5-pilih jenis upgrade') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.6-konfirmasi upgrade') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.7-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
