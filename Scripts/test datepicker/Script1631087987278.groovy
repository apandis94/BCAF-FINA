...
String cyear = Mobile.getText(findTestObject('DMS_FINA_Mobile/test/FINA_ResvBPKB_Year_DatePicker'), 0)

String cdate = Mobile.getText(findTestObject('DMS_FINA_Mobile/test/date'), 0)

System.print(cyear + cdate +"****")
