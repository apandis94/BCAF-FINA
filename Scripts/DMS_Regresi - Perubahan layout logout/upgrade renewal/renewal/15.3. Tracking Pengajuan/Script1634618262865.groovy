...
Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Menu_More Menu/Features/FINA_More_Tracking_Button'), 0)

Mobile.delay(2)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.8-list pengajuan') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Tracking/FINA_Tracking_List1_Button'), 0)

Mobile.delay(2)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.9-detail pengajuan') + '.png', FailureHandling.STOP_ON_FAILURE)
