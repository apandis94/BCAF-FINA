...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.1-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-15.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
