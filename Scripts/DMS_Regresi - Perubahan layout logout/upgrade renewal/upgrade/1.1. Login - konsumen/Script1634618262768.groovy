...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Text'), findTestData('DMS_Asr_Cakpro').getObjectValue('Login', 2), 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Password_Text'), findTestData('DMS_Asr_Cakpro').getObjectValue('Pass', 2), 0)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.1-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransicakpro) + 'skenario-1.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
