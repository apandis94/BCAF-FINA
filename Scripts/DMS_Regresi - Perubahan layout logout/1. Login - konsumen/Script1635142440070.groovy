...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-4.4-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathapplyonline) + 'skenario-4.5-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
