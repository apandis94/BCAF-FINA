...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-1.1-input username dan password') + '.png', 
...
Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Mobile_Main Menu/FINA_Mainmenu_LayKons_Button'), 0)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-1.9-berhasil logout') + '.png', FailureHandling.STOP_ON_FAILURE)
