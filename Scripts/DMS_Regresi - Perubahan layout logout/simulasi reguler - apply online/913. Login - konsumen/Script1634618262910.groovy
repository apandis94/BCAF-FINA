...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-13.1-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathregresi) + 'skenario-13.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
