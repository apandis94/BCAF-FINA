...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_OTR_Text'), 
    findTestData('Matriks').getObjectValue('OTR', 9), 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_DP persen_Text'), 
    findTestData('Matriks').getObjectValue('DP Persen', 9), 0)
...
Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_Wilayah_Lainnya_Dropdownval'), 
    0)

'Inputan simulasi matriks 9\r\n'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.9-1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'Hasil simulasi matriks 9'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.9-2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
