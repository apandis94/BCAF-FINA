...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_OTR_Text'), 
    findTestData('Matriks').getObjectValue('OTR', 10), 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_DP_Persen_Text'), 
    findTestData('Matriks').getObjectValue('DP Persen', 10), 0)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.10-1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.10-2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
