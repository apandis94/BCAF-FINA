...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_OTR_Text'), 
    findTestData('Matriks').getObjectValue('OTR', 5), 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_DP persen_Text'), 
    findTestData('Matriks').getObjectValue('DP Persen', 5), 0)
...
'Inputan simulasi matriks 5'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.5-1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'Hasil simulasi matriks 5\r\n'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.5-2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
