...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_OTR_Text'), 
    findTestData('Matriks').getObjectValue('OTR', 3), 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_DP persen_Text'), 
    findTestData('Matriks').getObjectValue('DP Persen', 3), 0)
...
MobileElement element = MobileElementCommonHelper.findElement(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_Tipe Asuransi_TLO_Dropdownval'), 
    10)
...
MobileElement element2 = MobileElementCommonHelper.findElement(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/New Car/Simulasi_Reguler_Wilayah_Lainnya_Dropdownval'), 
    10)

element2.click()

'Inputan simulasi matriks 3\r\n'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.3-1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'Hasil simulasi matriks 3'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.3-2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
