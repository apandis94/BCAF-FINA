...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-3-input username dan password') + '.png', 
...
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-3-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
