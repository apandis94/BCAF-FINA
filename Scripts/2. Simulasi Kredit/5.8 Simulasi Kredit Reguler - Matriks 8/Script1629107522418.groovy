...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_OTR_Text'), 
    findTestData('Matriks').getObjectValue('OTR', 8), 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_DP_Persen_Text'), 
    findTestData('Matriks').getObjectValue('DP Persen', 8), 0)
...
Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_Wilayah_Jakarta_Dropdownval'), 
    0)

'Inputan Simulasi Matriks 8\r\n'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.8-1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'Hasil Simulasi Matriks 8'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.8-2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
