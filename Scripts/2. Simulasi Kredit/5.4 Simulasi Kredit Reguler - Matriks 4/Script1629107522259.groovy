...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_OTR_Text'), 
    findTestData('Matriks').getObjectValue('OTR', 4), 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_DP_Persen_Text'), 
    findTestData('Matriks').getObjectValue('DP Persen', 4), 0)
...
MobileElement element = MobileElementCommonHelper.findElement(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_Asuransi_TLO_dropdownval'), 
    10)
...
MobileElement element2 = MobileElementCommonHelper.findElement(findTestObject('DMS_FINA_Mobile/FINA_Simulasi Kredit_Apply Online/Form Simulasi/Used Car/SimulasiKredit_Used_Wilayah_Sumatra dan Sekitarnya_dropdownval'), 
    10)

element2.click()

'Inputan Simulasi Matriks 4\r\n'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.4-1-input') + '.png', FailureHandling.STOP_ON_FAILURE)
...
'Hasil Simulasi Matriks 4'
Mobile.takeScreenshot(((baseDir + GlobalVariable.sprint3sspathMobile) + 'skenario-5.4-2-hasil') + '.png', FailureHandling.STOP_ON_FAILURE)
