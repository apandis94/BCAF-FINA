...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-3.3-list kendaraan') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-3.4-pilih tenor') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/RSMB 3'), 0)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/RSCC 3'), 0)

not_run: Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/TJH 10 3'), 0)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/TJH 25 3'), 0)

not_run: Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/TJH 50 3'), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-3.5-pilih jenis upgrade') + 
...
Mobile.setText(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/Upgrade - Input No Telp'), '085908982444', 0)

Mobile.delay(10)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-3.6-konfirmasi upgrade') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-3.7-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
