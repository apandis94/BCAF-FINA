...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-8.10-list billing belum dibayar') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-8.11-list billing sudah dibayar') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-8.13-kirim email billing') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-8.14-dokumen terkirim') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
not_run: Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-8.15-dokumen tersimpan') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
