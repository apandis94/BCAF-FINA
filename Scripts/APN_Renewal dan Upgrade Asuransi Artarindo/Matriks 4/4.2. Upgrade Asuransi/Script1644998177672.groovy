...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-4.3-list kendaraan') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-4.4-pilih tenor') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
not_run: Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/Radio Comprehensive - TLO 2'), 0)
...
not_run: Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Upgrade_Asuransi/FINA_UpgradeAsr_Detail_Perluasan_RSCC1_Checkbox'), 
    0)
...
not_run: Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-4.5-pilih jenis upgrade') + 
...
Mobile.setText(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/Upgrade - Input No Telp'), '085908982004', 0)

Mobile.delay(10)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-4.6-konfirmasi upgrade') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-4.7-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
