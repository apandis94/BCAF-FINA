...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-13.16-list billing belum dibayar') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-13.17-list billing sudah dibayar') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
