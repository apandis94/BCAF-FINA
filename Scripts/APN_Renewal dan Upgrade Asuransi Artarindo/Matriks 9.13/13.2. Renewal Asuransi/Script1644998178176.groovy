...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-13.3-list kendaraan') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-13.4-submit renewal') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('APN_FINA_MOBILE/Homescreen/Input No Telp Renewal'), '089903425678', 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Renewal_Asuransi/android.widget.EditText - Nomor Telepon  HP'), findTestData(
        'DMS_Asr_Raksa').getObjectValue('No tlp', 56), 0)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-13.5-konfirmasi renewal') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-13.6-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
