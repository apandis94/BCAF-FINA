...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-9.3-list kendaraan') + '.png', 
    FailureHandling.STOP_ON_FAILURE)

Mobile.delay(2)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-9.4-pilih tenor') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
