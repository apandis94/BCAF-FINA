...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-11.3-list kendaraan') + '.png', 
...
Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Renewal_Asuransi/FINA_RenewalAsr_DetailAsr_TLO 3thn_Radiobutton'), 0)

Mobile.delay(2)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-11.4-submit renewal') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('APN_FINA_MOBILE/Homescreen/Input No Telp Renewal'), '089790094532', 0)

Mobile.delay(10)

Mobile.takeScreenshot(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-11.5-konfirmasi renewal') + '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-11.6-proses submit berhasil') + 
