...
Mobile.tap(findTestObject('APN_Fina New Versi/List Data/Upgrade 1-2'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-5.3-list kendaraan') + '.png', 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Upgrade_Asuransi/FINA_UpgradeAsr_Detail_Tenor3_Checkbox'), 0)

Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Upgrade_Asuransi/FINA_UpgradeAsr_Detail_Tenor4_Checkbox'), 0)

Mobile.delay(5)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-5.4-pilih tenor') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.swipe(0, 1300, 0, 200)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/Radio Comprehensive - TLO 3'), 0)

Mobile.swipe(0, 1400, 0, 200)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/Radio Comprehensive - TLO 4'), 0)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/RSMB 4'), 0)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/RSCC 4'), 0)

not_run: Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/TJH 10 4'), 0)

Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/TJH 25 4'), 0)

not_run: Mobile.tap(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/TJH 50 4'), 0)

not_run: Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Upgrade_Asuransi/FINA_UpgradeAsr_Detail_Asuransi_Comprehensive1_Checkbox'), 
    0)
...
not_run: Mobile.tap(findTestObject('DMS_FINA_Mobile/FINA_Upgrade_Asuransi/FINA_UpgradeAsr_Detail_Asuransi_Comprehensive2_Checkbox'), 
    0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-5.5-pilih jenis upgrade') + 
...
Mobile.setText(findTestObject('APN_FINA_MOBILE/Upgrade Asuransi/Upgrade - Input No Telp'), '085908986541', 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Upgrade_Asuransi/android.widget.EditText - Nomor Telepon  HP'), findTestData(
        'DMS_Asr_Cakpro').getObjectValue('No tlp', 19), 0)

Mobile.delay(10)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-5.6-konfirmasi upgrade') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-5.7-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
