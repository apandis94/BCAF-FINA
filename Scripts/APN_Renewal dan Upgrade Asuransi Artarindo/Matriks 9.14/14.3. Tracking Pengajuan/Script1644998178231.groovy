...
MMobile.tap(findTestObject('APN_FINA_MOBILE/Homescreen/Button Menu Lainnya'), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-14.8-list pengajuan') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-14.9-detail pengajuan') + 
