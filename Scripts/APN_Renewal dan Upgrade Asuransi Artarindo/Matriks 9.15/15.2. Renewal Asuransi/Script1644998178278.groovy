...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-15.3-list kendaraan') + '.png', 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('APN_Fina New Versi/List Data/Renewal 1-3'), 0)
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-15.4-submit renewal') + '.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.setText(findTestObject('APN_FINA_MOBILE/Homescreen/Input No Telp Renewal'), '082312345433', 0)
...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Renewal_Asuransi/android.widget.EditText - Nomor Telepon  HP'), findTestData(
        'DMS_Asr_Raksa').getObjectValue('No tlp', 63), 0)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-15.5-konfirmasi renewal') + 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-15.6-proses submit berhasil') + 
    '.png', FailureHandling.STOP_ON_FAILURE)
