...
Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Text'), findTestData('DMS_Asr_Raksa').getObjectValue('Login', 29), 0)

Mobile.setText(findTestObject('DMS_FINA_Mobile/FINA_Login/Login_Password_Text'), findTestData('DMS_Asr_Raksa').getObjectValue('Pass', 29), 0)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-7.1-input username dan password') + '.png', 
...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathasuransiraksa) + 'skenario-7.2-berhasil login') + '.png', FailureHandling.STOP_ON_FAILURE)
