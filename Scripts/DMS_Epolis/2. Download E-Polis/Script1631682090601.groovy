...
Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathepoliscakpro) + 'skenario-2.1-list kendaraan') + '.png', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('DMS_FINA_Mobile/E-polis/FINA_Epolis_List1_Button'), 0)

Mobile.delay(2)

Mobile.takeScreenshotAsCheckpoint(((baseDir + GlobalVariable.sspathepoliscakpro) + 'skenario-2.1-download epolis') + '.png', FailureHandling.STOP_ON_FAILURE)
