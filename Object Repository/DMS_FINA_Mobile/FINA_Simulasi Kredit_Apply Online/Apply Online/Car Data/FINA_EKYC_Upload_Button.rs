...
<MobileElementEntity>
   ...
   <name>FINA_EKYC_Upload_Button</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'image preview4' or . = 'image preview4') and @resource-id = 'image-preview4']</locator>
