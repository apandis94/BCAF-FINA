...
<MobileElementEntity>
   ...
   <name>simbudget_hargakendaraan_text</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Rp ' or . = 'Rp ') and @resource-id = 'com.vq.mbrochuregp.client.android:id/et_simulasi_harga_kendaraan']</locator>
