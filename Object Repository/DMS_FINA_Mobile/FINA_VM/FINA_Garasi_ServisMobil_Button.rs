...
<MobileElementEntity>
   ...
   <name>FINA_Garasi_ServisMobil_Button</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'Servis Mobil' or . = 'Servis Mobil')]</locator>
