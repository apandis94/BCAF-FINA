...
<MobileElementEntity>
   ...
   <name>FINA_VM_BurgerM_PartnerKami_Button</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Partner Kami' or . = 'Partner Kami')]</locator>
